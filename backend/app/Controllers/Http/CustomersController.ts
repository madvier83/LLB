...
export default class CustomersController extends BaseController {
  ...
  public async store({ request }) {
    return super.store({
      ...
      kecamatan_kirim: request.all().kecamatankirim,
      kecamatan_customer: request.all().kecamatancustomer,
      provinsi_kirim: request.all().provinsikirim,
      provinsi_customer: request.all().provinsicustomer,
